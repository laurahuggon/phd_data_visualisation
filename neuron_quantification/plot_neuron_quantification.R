...
sample_means = mean_by_sample(dapibtub_df, "percentage_positive")
...
# Perform t-test
result = perform_test(sample_means, "N_Mean")
...
# Make plot
plot = plot_data(group_means, "Global_Mean", sample_means, "N_Mean")
...
# Extract results
results_df = extract_test_results(test_result, sample_means)
