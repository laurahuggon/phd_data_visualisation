...
plot_data = function(group_data, sample_data, annotation_data, x = "Genotype", sd = "SD") {
  ...
  p = p + geom_point(data = sample_data, aes_string(x = x,
                                                    ...
                                                    color = "Staining_to_Imaging"),
                     position = position_dodge(0), size = 1.5, stroke = 1.5, fill = "white") +
...
png(paste0(parent_filepath, relative_filepath, marker, "_cellbody_", measurement, "_raw_colour.png"), width=825, height=1335, res=300)
