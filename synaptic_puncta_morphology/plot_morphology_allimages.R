...
group_mean_density = mean_by_group(nis_elements_df, "Density")
group_mean_volume = mean_by_group(nis_elements_df, "MeanVolume")
...
density_results = perform_tests_with_report(nis_elements_df, "Density")
volume_results = perform_tests_with_report(nis_elements_df, "MeanVolume")
...
density_plot = plot_by_genotype_div(group_mean_density, "Density", density_annotations)
volume_plot = plot_by_genotype_div(group_mean_volume, "MeanVolume", volume_annotations)
...
# Save plot
ggsave(paste0(parent_filepath, relative_filepath, protein_name, "_all_plots_allimages.png"), plot=all_plots, width=5.25, height=10.5, dpi=300, bg="white")
